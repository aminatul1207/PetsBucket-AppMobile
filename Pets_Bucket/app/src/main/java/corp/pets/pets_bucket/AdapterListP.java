...
public class AdapterListP extends RecyclerView.Adapter<AdapterListP.ViewHolder>{
    //private AlertDialog.Builder builder;
    Context context;
    ArrayList<HashMap<String, String>> list_data;

    public AdapterListP(data_pkn mainActivity, ArrayList<HashMap<String, String>> list_data) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        Glide.with(context)
                .load("http://192.168.43.220/PetS_Bucket/pakan/" + list_data.get(position).get("gambar"))
                .crossFade()
